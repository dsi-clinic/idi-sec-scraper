...
Two roles:
  1. Task Execution Role — used by the ECS agent to pull images and write
     awslogs. (No genuine secrets: the SEC User-Agent is a public contact string
     injected as a plain env var, not a secret store entry.)
